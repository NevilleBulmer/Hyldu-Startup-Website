...
}
{
    ...
    $userAccountID = $_GET['id'];
    $retrieveUser = DatabaseConnectivity::getInstance()->get('hyldu_users', array('userID', '=', $userAccountID));
...
<div class="super_container">
    ...
    <?php
        foreach($retrieveUser->results() as $users)
        {
    ?>
	<div class="home">
		...
		<div class="home_title">
			<h2><?php echo escape($users->firstname . " " . $users->surname); ?>'s Account</h2>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img class="rounded-circle" src="<?php echo escape($users->image); ?>" alt="">
                                        </div>
                                    </div>
                                        ...
                                        <div class="about-info">
                                            <p>
                                                <span class="title-s">Name: </span> 
                                                    <span>
                                                        <?php echo escape($users->firstname . " " . $users->surname); ?>
                                                    </span>
                                            </p>
                                            <p>
                                                <span class="title-s">C/Role: </span> 
                                                    <span>
                                                        <?php echo escape($users->current_role); ?>
                                                    </span>
                                            </p>
                                            <p>
                                                    ...
                                                    <span>
                                                        <?php
                                                            if($DBInteraction->isLoggedIn())
                                                            {
                                                                ...
                                                                {
                                                                    ?>
                                                                        <?php echo escape($users->email); ?>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                        <a href="upgrade.php">Upgrade to uncover</a>
                                                                    <?php
                                                                }
                                                            }
                                                        ?>
                            ...
                            <div class="col-md-6">
                                <div class="about-me pt-4 pt-md-0">
                                    ...
                                    <p class="lead">
                                        <?php echo escape($users->biography); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
